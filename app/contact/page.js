          ...
          <div className="lg:col-span-1 space-y-6">
            ...
            <div className="bg-white rounded-xl shadow-sm p-6 hover:shadow-md transition">
              ...
              <p className="text-gray-600">
                <a href="mailto:support@jobcliff.com" className="text-blue-600 hover:underline">
                  support@jobcliff.com
                </a>
              </p>
              <p className="text-gray-600 mt-1">
                <a href="mailto:careers@jobcliff.com" className="text-blue-600 hover:underline">
                  careers@jobcliff.com
                </a>
              </p>
            </div>
            ...
            <div className="bg-white rounded-xl shadow-sm p-6">
              ...
              <div className="flex gap-4">
                <a href="#" className="w-10 h-10 bg-gray-100 rounded-full flex items-center justify-center hover:bg-blue-100 hover:text-blue-600 transition">
          ...
          <div className="lg:col-span-2">
            <div className="bg-white rounded-xl shadow-sm p-8">
              ...
              {submitted ? (
                <div className="bg-green-50 border border-green-200 rounded-lg p-6 text-center">
                  ...
                  <p className="text-gray-600">Thank you for reaching out. We'll respond to your query shortly.</p>
                  <button
            ...
            <div className="mt-8 bg-white rounded-xl shadow-sm overflow-hidden">
              <div className="h-64 bg-gray-200 relative">
                <iframe
                  src="https://www.google.com/maps/embed?pb=!1m18!1m12!1m3!1d15551.915466650625!2d77.5945627!3d12.9715987!2m3!1f0!2f0!3f0!3m2!1i1024!2i768!4f13.1!3m3!1m2!1s0x3bae1670c9b44e6d%3A0xf8dfc3e8517e4fe0!2sBengaluru%2C%20Karnataka!5e0!3m2!1sen!2sin!4v1705641234567!5m2!1sen!2sin"
                  width="100%"
                  height="100%"
                  style={{ border: 0 }}
                  allowFullScreen
